    ...
    if ($('#total-sales-chart').length) {
      ...
      var data = {
        ...
        datasets: [
          {
            label: '2022',
            data: [45, 42, 30, 30, 18, 22, 16, 21, 22, 22, 22, 20, 24, 20, 18, 22, 30, 34 ,32, 33, 33, 24, 25, 34 , 30, 34, 19 ,34, 18, 10, 22, 24, 20, 22, 20, 21, 10, 10, 5, 9, 14, 45, 18, 26, 35, 78, 15, 45],
            borderColor: [
              'transparent'
            ],
            borderWidth: 2,
          ...
          {
            label: 'Next years',
            data: [45, 88, 92, 90, 98, 98, 90, 92, 78, 88, 84, 76, 80, 72, 74, 74, 88, 80, 72, 62, 62, 72, 72, 78, 78, 72, 75, 78, 68, 68, 60, 68, 70, 75, 70, 80, 82, 78, 78, 84, 82 ],
            borderColor: [
              'transparent'
            ],
            borderWidth: 2,
